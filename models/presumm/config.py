...
def get_args():
    ...
    parser.add_argument("-bert_data_path", default=DATA_DIR + '/cnndm')
    parser.add_argument("-model_path", default=MODEL_DIR)
    parser.add_argument("-result_path", default='results/cnndm')
    parser.add_argument("-temp_dir", default='results/')

    parser.add_argument("-batch_size", default=140, type=int)
    parser.add_argument("-test_batch_size", default=500, type=int)
    parser.add_argument("-max_pos", default=512, type=int)
    parser.add_argument("-bert_max_pos", default=1024, type=int)
